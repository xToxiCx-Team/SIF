...
###################################################################
'''
This Script Copyed By Michael Magdy
'''
###################################################################
#                             COLOR 
...
def baliho():
	try:
		...
		print ' ' + W
		print ('X T O X I C X').center(44)
		print ('[Facebook Informtions Gathring]').center(44)
...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Name:        Scraper Facebook Information
    Version:     1.0
    Facebook:    https://www.fb.com/xToxiCx.Team/
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'Start' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'Start' + W +'/' + R +'Bot ' + W + '>> ')
...
def dump_mail():
	...
	try:
		...
		out = open('output/' + n[0].split(' ')[0] + '_Emails.txt','w')
		...
		print '[*] File saved: output/' + n[0].split(' ')[0] + '_Emails.txt'
		main()
